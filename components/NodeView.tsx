...
type RowRendererArgs = {stop: TrainStop, index?: number, type: string, time: string, to?: string, marudor?: string}

function SingleRowRenderer({currentRow, nextRow, lastRow}: {currentRow: RowRendererArgs, nextRow: RowRendererArgs, lastRow: RowRendererArgs}) {
    let bottom = null
...
export function TimetableRenderer({rows}: {rows: RowRendererArgs[]}) {
    return (
        <TimetableContainer>
